...
class MovieResponse {
  ...
  @override
  String toString() {
    return "MoveResponse(title: ${data?.movie?.slug ?? "empty"} .......";
  }
  // MovieEntity toMovieEntity() {
  //   return MovieEntity(
  //       id: data!.movie!.id!.toInt(),
  //       rating: data?.movie?.rating?.toDouble() ?? 0.0,
  //       imageUrl: data?.movie?.largeCoverImage ?? "",
  //       movieDetail: MovieDetailModel(
  //           cast: data!.movie!.cast!.map((cast) =>
  //               CastModel(name: cast.name ?? "",
  //                   character: cast.characterName ?? "",
  //                   imageUrl: cast.urlSmallImage ?? "")).toList(),
  //           title: data?.movie?.title ?? "",
  //           year: data?.movie?.year.toString() ?? "",
  //           genres: data?.movie?.genres ?? [],
  //           likeCount: data?.movie?.likeCount?.toInt() ?? 0,
  //           summary: data?.movie?.descriptionFull ?? "",
  //           trailerYTCode: data?.movie?.ytTrailerCode ?? "",
  //           backgroundImage: data?.movie?.backgroundImage ?? '',
  //           screenshotImagesUrl: [data?.movie?.largeScreenshotImage1 ?? "",
  //             data?.movie?.largeScreenshotImage2 ?? "",
  //             data?.movie?.largeScreenshotImage3 ?? "",
  //           ],
  //           runtime: data?.movie?.runtime?.toInt() ?? 0
  //
  //       )
  //   );
  // }
  ...
  MovieEntity toMovieEntity() {
    return MovieEntity(
        ...
        movieDetail: MovieDetailModel(
            ...
            summary: descriptionFull ?? "",
            trailerYTCode: ytTrailerCode ?? "",
            backgroundImage: backgroundImage ?? '',
            screenshotImagesUrl: [largeScreenshotImage1 ?? "",
